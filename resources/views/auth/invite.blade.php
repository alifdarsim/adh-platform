                ...
                <div class="nk-block nk-block-middle nk-auth-body wide-xs">
                    ...
                    <div class="card card-bordered mt-4 p-5">
                        <div class="nk-block-head">
                            <div class="nk-block-head-content"><h5 class="nk-block-title">Password for Admin Account</h5>
                                <div class="nk-block-des">
                                    <p>Please confirm your password to login to your AsiaDealHub account.</p>
                                    <span class="fs-12px">Login Email:</span><p class="fs-14px bg-light rounded px-2 py-2"> {{$user->email}}</p>
                                </div>
                            </div>
                        </div>
