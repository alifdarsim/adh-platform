                    ...
                    <div class="card card-bordered mt-4">
                        <div class="card-inner card-inner-lg pt-2">
                            <div class="nk-block-head py-2">
                                <div class="center fw-bold fs-18px tw-text-slate-600">Client Login</div>
                            </div>
                            ...
                            <div class="form-note-s2 text-center mt-3">
                                ...
                                <a class="tw-underline tw-text-red-500" href="{{route('register.index', 'client')}}">Create Client Account</a>
                            </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.isadmin) {
                        ...
                        let text = response.isSuperAdmin === true ? 'Admin' : 'ADH Member';
                        console.log(text);
                        ...
                        window.location.href = "{{route('client.overview.index')}}";
                    }
                },
