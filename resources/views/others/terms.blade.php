                        ...
                        <div class="nk-block">
                            <div class="card card-bordered">
                                <div class="card-inner card-inner-xl">
                                    <div class="entry"><h3>Terms and Conditions</h3>
                                        <p>We’ve decided to make these Terms available under a <strong>Creative
                                                Commons</strong> license. You can grab a copy of these Terms and other
                                            legal
                                            documents on Github. You’re more than welcome to copy them, adapt them, and
                                            repurpose them for your own use.</p><h4>Introduction</h4>
                                        <p>These Website Standard Terms and Conditions written on this webpage shall
                                            manage
                                            your use of our website, Webiste Name accessible at Website.com.</p>
                                        ...
                                        <h4>
                                            Intellectual Property Rights</h4>
                                        <p>Other than the content you own, under these Terms, Company Name and/or its
                                        ...
                                        <p>You are granted limited license only for purposes of viewing the material
                                            contained on this Website.</p><h4>Restrictions</h4>
                                        ...
                                        <ul class="list list-sm list-checked">
                                            ...
                                            <li>Certain areas of this Website are restricted from being access by you
                                                and
                                        ...
                                        <p>Your Content must be your own and must not be invading any third-party's
                                            rights.
                                            Company Name reserves the right to remove any of Your Content from this
                                            Website
                                            at any time without notice.</p><h4>No warranties</h4>
                                        <p>This Website is provided “as is,” with all faults, and Company Name express
                                            ...
                                            shall be interpreted as advising you.</p><h4>Limitation of liability</h4>
                                        <p>In no event shall Company Name, nor any of its officers, directors and
                                            ...
                                            with
                                            your use of this Website whether such liability is under contract. Company
                                            Name,
                                            ...
                                            related to your use of this Website.</p><h4>Indemnification</h4>
                                        ...
                                        <p>If any provision of these Terms is found to be invalid under any applicable
                                            ...
                                            herein.</p><h4>Variation of Terms</h4>
                                        <p>Company Name is permitted to revise these Terms at any time as it sees fit,
                                            and
                                            by using this Website you are expected to review these Terms on a regular
                                            basis.</p><h4>Assignment</h4>
                                        <p>The Company Name is allowed to assign, transfer, and subcontract its rights
                                            ...
                                            obligations under these Terms.</p><h4>Entire Agreement</h4>
                                        <p>These Terms constitute the entire agreement between Company Name and you in
                                            ...
                                            understandings.</p><h4>Governing Law &amp; Jurisdiction</h4>
                                        <p>These Terms will be governed by and interpreted in accordance with the laws
                                            of
                                            the State of Country, and you submit to the non-exclusive jurisdiction of
                                            the
