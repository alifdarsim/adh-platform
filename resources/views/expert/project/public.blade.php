    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Public Projects</h3>
    ...
    <div class="nk-block">
        @if ($projects->count() == 0)
            <div class="card py-5 mt-3 tw-items-center tw-flex tw-justify-center">
                ...
                <h4 class="tw-text-2xl tw-font-semibold tw-mt-5">Cannot find any public projects</h4>
                <p class="tw-text-gray-500 tw-mt-2">There is no publicly available project to be seen.</p>
            </div>
        @else
...
@push('scripts')
    ...
    <script>
        datatableInit('#datatable', {
            ajax: '{{ route('expert.projects.datatable_public') }}',
            simpleTable: true,
            columnDefs: [{
                "orderable": false,
                "targets": [0, 1, 2, 3]
