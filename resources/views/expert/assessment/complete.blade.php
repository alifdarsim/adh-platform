                        ...
                        <div id="introduction">
                            ...
                            @if ($assessment->status == 'complete')
                                ...
                                <div class="text-center pt-3">
                                    <a href="{{route('expert.profile.index')}}" class="btn btn-primary tw-w-80 clickable tw-justify-center">Go to Expert Profile</a>
                                </div>
                                <div class="text-center pt-3">
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            Swal.fire(
                                ...
                                if (result.isConfirmed) {
                                    window.location.href = '{{route('expert.assessment.index')}}';
                                }
                            });
                        }
                    });
