...
@section('content')
    ...
    <script type="text/javascript">
        tinymce.init({
            ...
            // readonly: true,
            plugins: [
                "export", "autolink",  "lists", "link", "preview" ,
        ...
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">
                    <a class="back" href="{{route('expert.projects.index')}}"><i
    ...
    <div class="nk-block">
        <div class="tw-grid tw-grid-cols-12 tw-gap-4">
            <div class="card card-bordered tw-col-span-8">
            ...
            <div class="card card-bordered tw-col-span-4">
                <div class="card-inner">
...
@push('scripts')
    ...
    <script>
        ...
        function signedDocument(){
            ...
            content = content.replaceAll('<span id="expert_signed_date"></span>', `<span>${moment().format('DD/MM/YYYY')}</span>`);
            tinymce.activeEditor.setContent(content);
        }
