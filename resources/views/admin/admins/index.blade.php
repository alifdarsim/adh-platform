            ...
            $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        data: 'status',
                        render: function (data) {
                            let status = data === 1 ? 'Active' : data === 2 ? 'Suspend' : 'Inactive';
                            let color = data === 1 ? 'success' : data === 2 ? 'danger' : 'warning';
                            return ` <span class="tb-status">27 Nov 2023</span>`
                        },
                        className: 'nk-tb-col'
                    },
                    {
