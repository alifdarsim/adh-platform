        ...
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                ...
                <div class="nk-block-des text-soft">
                    <p>You can edit or create a new contract template here.</p>
                </div>
            </div>
            <div class="nk-block-head-content">
                <div class="toggle-wrap nk-block-tools-toggle">
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            <li class="nk-block-tools-opt"><a onclick="addTemplate()" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Create New Contract Template</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="card card-bordered card-preview">
            ...
            <table id="datatable" class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="true">
                ...
                <tr class="nk-tb-item nk-tb-head">
                    ...
                    <th class="nk-tb-col"><span class="sub-text">Version</span></th>
...
@push('scripts')
    ...
    <script>
        datatableInit('#datatable', {
            ajax: '{{route('admin.contract-template.index')}}',
            simpleTable: true,
            order: [0, 'desc'],
            columnDefs: [
                {"className": "nk-tb-col py-2", "targets": "_all"},
                {
                    ...
                    "createdCell": function(td, cellData, rowData) {
                        $(td).on('click', () => window.location.href =
                            '{{ route('admin.contract-template.show', '') }}/' + rowData.id)
                    }
                },
            ],
            columns: [
                                    ...
                                    <div class="drodown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <ul class="link-list-opt no-bdr">
                                                ...
                                                <li><a onclick="deleteTemplate('${data}')"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
        ...
        function deleteTemplate(id) {
            Swal.fire({
                ...
                text: 'Are you sure you want to delete this contract template?',
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{route('admin.contract-template.destroy', '')}}/' + id,
                        method: 'DELETE',
                        headers: {
                        ...
                        success: function (response) {
                            Swal.fire({
                                title: 'Success',
                                text: 'Contract template has been deleted',
                                icon: 'success',
