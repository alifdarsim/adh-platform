                ...
                <div class="modal-body">
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <a href="" id="receipt_link" target="_blank" class="btn text-capitalize btn-outline-info bg-white py-1 hover:tw-text-blue-600 px-5"><i class="fa-solid fa-receipt me-1"></i>View Receipt</a>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="info" id="info" class="form-control" disabled required placeholder="Eg: Payment Method: Direct Transfer&#10;Bank: OCBC Bank&#10;Ref Number: 00001061;&#10;Payment Time: 25/05/2023 14:10 PM;"></textarea>
                        </div>
                        <div class="form-group d-flex justify-end">
                            <button onclick="confirmClientPayment()" class="btn btn-primary px-5">Verify & Confirm Client Payment</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body">
                    <div>
                        <div class="form-group">
                            ...
                            <input name="project_name" id="project_name" class="form-control" placeholder="" value="" disabled>
                        </div>
                        <div class="form-group">
                            <label for="receipt">Payment Receipt</label>
                            <div class="form-control-wrap">
                                <a href="" id="release_receipt_link" target="_blank" class="btn text-capitalize btn-outline-info bg-white py-1 hover:tw-text-blue-600 px-5"><i class="fa-solid fa-receipt me-1"></i>View Receipt</a>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="release_amount">Total Amount</label>
                            <input name="release_amount" id="release_amount" class="form-control" placeholder="Eg: SGD50000" disabled>
                        </div>
                        <div class="form-group mt-3">
                            <label for="file_release">Payment Screenshot</label>
                            <input type="file" name="file_release" id="file_release" accept="image/png, image/gif, image/jpeg, application/pdf" class="form-control" required>
                        </div>
                        <div class="form-group d-flex justify-end">
                            <button onclick="confirmExpertRelease()" class="btn btn-primary px-5">Mark as Release Payment</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        datatableInit('#datatable', {
            ...
            columns: [
                ...
                },
                {
                    data: 'payment',
                    render: function (data, type, row) {
                        let info = data.received_info;
                        return `<button onclick="view('${row.name}','${data.received_amount}','${info}', '{{config('app.url')}}${data.received_receipt}', '${row.pid}')" class="btn btn-xs text-capitalize btn-info py-1"><i class="fa-solid fa-eye"></i></button>`;
                    }
                },
                {
                    data: 'payment',
                    ...
                    render: function (data, type, row) {
                        ...
                        let color = data === 'pending' ? 'danger' : (data === 'pending_verification' ? 'warning' : 'success');
