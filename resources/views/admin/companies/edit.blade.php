    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Edit Company Database</h3>
                ...
                <div class="preview-block">
                    <div class="row gy-4">
                        ...
                        <div class="row mt-1">
                            <div class="tw-flex">
                                <div class="mx-5">
                                    <img src="{{$company->img_url ?? '/images/no-company.png'}}" id="company_image" alt="" class="tw-h-[160px] !tw-w-[160px]">
                                ...
                                <div class="row tw-w-full">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="company_name" value="{{$company->name ?? ''}}" placeholder="Eg: Asia Deal Hub">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="company_slogan" value="{{$company->slogan ?? ''}}" placeholder="Eg: Expert based Research & Cross Border Business Matching, Sourcing and Transaction">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" value="{{$company->website ?? ''}}" id="company_website" placeholder="Eg: https://asiadealhub.com">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="linkedin_url"  value="{{$company->linkedin_vanity ?? ''}}" placeholder="Eg: https://www.linkedin.com/company/asiadealhub">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    ...
                                    <input id="company_establish" type="text" value="{{$company->establish ?? ''}}" class="form-control date-picker" placeholder="Eg: 2005" data-date-format="yyyy" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 mt-2">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" value="{{$company->company_size ?? ''}}" id="company_size" placeholder="Eg: 11-50">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 mt-2">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <textarea id="about" class="form-control" type="text" placeholder="Eg: John Metal Trading Pte Ltd is a dynamic and innovative metal trading company based in Singapore. With over two decades of experience in the industry, we have established ourselves as a trusted partner for businesses seeking top-quality metal products and exceptional customer service. Our mission is to provide our clients with the highest quality metal products, exceptional service, and competitive pricing. We are committed to forging long-lasting partnerships with our customers, suppliers, and stakeholders." required>{{$company->about ?? ''}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="pic_name" placeholder="Eg: Micheal John" value="{{$company->pic->name ?? ''}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="pic_position" placeholder="Eg: CEO" value="{{$company->pic->position ?? ''}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="pic_contact" placeholder="Eg: +60123456789" value="{{$company->pic->contact ?? ''}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="pic_email" placeholder="Eg: contact@johnmetaltrading.com" value="{{$company->pic->email ?? ''}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="address1" placeholder="Eg: 123 Main St" value="{{$company->address->address ?? ''}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="postal" placeholder="Eg: 10001" value="{{$company->address->postal ?? ''}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="city" placeholder="Eg: New York" value="{{$company->address->city ?? ''}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" id="state" placeholder="Eg: NY" value="{{$company->address->state ?? ''}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
...
{{--                                    <input type="number" id="revenue" class="form-control number-spinner" placeholder="Not Set" value="{{$company->financial->revenue ?? ''}}">--}}
...
{{--                                <div class="form-control-wrap number-spinner-wrap">--}}
{{--                                    <button class="btn btn-icon btn-outline-light number-spinner-btn number-minus" data-number="minus"><em class="icon ni ni-minus"></em></button>--}}
{{--                                    <input type="number" id="operating_profit" class="form-control number-spinner" placeholder="Not Set" value="{{$company->financial->operating_profit ?? ''}}">--}}
{{--                                    <button class="btn btn-icon btn-outline-light number-spinner-btn number-plus" data-number="plus"><em class="icon ni ni-plus"></em></button>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                <div class="form-control-wrap number-spinner-wrap">--}}
{{--                                    <button class="btn btn-icon btn-outline-light number-spinner-btn number-minus" data-number="minus"><em class="icon ni ni-minus"></em></button>--}}
{{--                                    <input type="number" id="net_profit" class="form-control number-spinner" placeholder="Not Set" value="{{$company->financial->net_profit ?? ''}}">--}}
{{--                                    <button class="btn btn-icon btn-outline-light number-spinner-btn number-plus" data-number="plus"><em class="icon ni ni-plus"></em></button>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                <div class="form-control-wrap number-spinner-wrap">--}}
{{--                                    <button class="btn btn-icon btn-outline-light number-spinner-btn number-minus" data-number="minus"><em class="icon ni ni-minus"></em></button>--}}
{{--                                    <input type="number" id="total_assets" class="form-control number-spinner" value="" placeholder="Not Set" value="{{$company->financial->total_assets ?? ''}}">--}}
{{--                                    <button class="btn btn-icon btn-outline-light number-spinner-btn number-plus" data-number="plus"><em class="icon ni ni-plus"></em></button>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                <div class="form-control-wrap number-spinner-wrap">--}}
{{--                                    <button class="btn btn-icon btn-outline-light number-spinner-btn number-minus" data-number="minus"><em class="icon ni ni-minus"></em></button>--}}
{{--                                    <input type="number" id="current_market_capital" class="form-control number-spinner" placeholder="Not Set" value="{{$company->financial->current_market_capital ?? ''}}">--}}
{{--                                    <button class="btn btn-icon btn-outline-light number-spinner-btn number-plus" data-number="plus"><em class="icon ni ni-plus"></em></button>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                <div class="form-control-wrap number-spinner-wrap">--}}
{{--                                    <button class="btn btn-icon btn-outline-light number-spinner-btn number-minus" data-number="minus"><em class="icon ni ni-minus"></em></button>--}}
{{--                                    <input type="number" id="capital" class="form-control number-spinner" placeholder="Not Set" value="{{$company->financial->capital ?? ''}}">--}}
{{--                                    <button class="btn btn-icon btn-outline-light number-spinner-btn number-plus" data-number="plus"><em class="icon ni ni-plus"></em></button>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
                        <div class="col-sm-12 mt-5">
                            <div class="form-group">
                                ...
                                <a onclick="registerCompany()" class="btn btn-primary btn-block px-5"><em class="icon ni ni-save me-1"></em>Update Company</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        tagifyInit();
        function tagifyInit(){
            let special_keyword = $('#specialties_keyword').tagify({
                maxTags: 20,
            });
            special_keyword.data('tagify').addTags({!! json_encode($company->specialties ?? []) !!});
            let other_keyword =  $('#other_keyword').tagify({
                maxTags: 10,
            });
            other_keyword.data('tagify').addTags({!! json_encode($company->other_keyword ?? []) !!});
        }
        ...
        function setCountry(){
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#country').html(html);
                    $('#country').val('{{$company->address->country ?? ''}}').trigger('change');
                }
            });
        }
        ...
        function setCompanyType(){
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#company_type').val('{{$company->type_id ?? ''}}').trigger('change');
                }
            });
        }
        ...
        $( document ).ready(function() {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#main-industry').val('{{$company->industry->main ?? ''}}').trigger('change');
                }
            });
        });
        ...
        $('#main-industry').on('change', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#sub-industry').val('{{$company->industry->id ?? ''}}').trigger('change');
                }
            });
        });
        ...
        function registerCompany(){
            ...
            _Swal.loading('Loading...', 'Updating company info...');
