            ...
            var table = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        className: 'nk-tb-col',
                        render: function (data, type, row) {
                            if (data === 'active') return ` <span class="badge ms-1 rounded-pill text-capitalize bg-success center w-80px">Active</span>`;
                            else return ` <span class="badge ms-1 rounded-pill text-capitalize bg-warning center w-80px">Pending</span>`
                        }
                    },
                    {
                        data: 'id',
