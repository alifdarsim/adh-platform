    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Privacy Policy Editor</h3>
                <div class="nk-block-des text-soft">
                    <p>Edit and manage the privacy policy here.</p>
                </div>
            </div>
            <div class="nk-block-head-content">
                <a href="{{route('others.policy')}}" target="_blank" class="btn btn-white btn-outline-primary"><em class="icon ni ni-eye"></em><span>View Privacy Policy</span></a>
        ...
        function updateData(content){
            $.ajax({
                ...
                success: function (response) {
                    ...
                    _Swal.success('Privacy Policy Updated!', 'Privacy Policy has been updated successfully!');
                },
