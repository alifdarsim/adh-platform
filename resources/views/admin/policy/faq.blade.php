    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">FAQ Editor</h3>
                <div class="nk-block-des text-soft">
                    <p>Edit and manage the FAQ here.</p>
                </div>
            </div>
            <div class="nk-block-head-content">
                <a href="{{route('others.faq')}}" target="_blank" class="btn btn-white btn-outline-primary"><em class="icon ni ni-eye"></em><span>View FAQ Page</span></a>
...
@push('scripts')
    ...
    <script>
        ...
        function updateData(content){
            $.ajax({
                url: '{{route('admin.editor.update', 'faq')}}',
                type: 'PUT',
                data: {
                    _token: '{{csrf_token()}}',
                    content: content
                ...
                success: function (response) {
                    ...
                    _Swal.success('FAQ Updated!', 'FAQ has been updated successfully!')
                },
