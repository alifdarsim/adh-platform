    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Registered Client List</h3>
                <div class="nk-block-des text-soft">
                    <p>Total numbers of registered client users</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card card-bordered card-preview">
            ...
            <table id="datatable" class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="true">
                ...
                <tr class="nk-tb-item nk-tb-head">
                    ...
                    <th class="nk-tb-col tb-col-lg"><span class="sub-text">Register</span></th>
...
@push('scripts')
    ...
    <script>
        ...
        datatableInit('#datatable', {
            ajax: '{{route('admin.users-client.index')}}',
            order:  [[4, 'desc']],
            columnDefs: [
            ...
            columns: [
                ...
                },
                {
                    data: 'phone',
                    render: function (data, type, row) {
                        return row.phone_code + data || 'N/A';
                    }
                },
                {
                    data: 'status',
                ...
                },
                {
                    data: 'last_login_at',
                    render: function (data) {
                        return data !== null ? moment(data).format('DD/MM/YYYY hh:mm A') : 'N/A';
                    }
                },
                {
                    data: 'created_at',
        ...
        function remove(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{route('admin.users-client.destroy', '')}}/" + id,
                        type: 'DELETE',
                        data: {
                            _token: '{{csrf_token()}}'
                        },
