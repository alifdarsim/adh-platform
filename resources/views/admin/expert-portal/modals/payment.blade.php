<div class="modal fade" tabindex="-1" id="paymentModals">
    <div class="modal-dialog modal-lg" style="--bs-modal-width: 800px;">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-md">
                <h5 class="title">Project Payment</h5>
                <div class="d-flex justify-between">
                    <p class="fs-14px">Title: <span id="payment_project_title"></span></p>
{{--                    <div>--}}
...
@push('scripts')
    <script>
        ...
        function setPayment(project_expert_id, title = null) {
