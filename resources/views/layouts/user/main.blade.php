...
<head>
    ...
    <link href="https://ka-f.fontawesome.com/releases/v6.5.2/css/pro.min.css" rel="stylesheet">
    @stack('stylesheet')
...
{{--                                                <li><a href="{{route('expert.account.payment')}}"><em class="icon ni ni-bell"></em><span>Payment Details</span></a></li>--}}
{{--                                            @endif--}}
