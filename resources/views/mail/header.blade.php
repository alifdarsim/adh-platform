                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="pc-w620-spacing-24-0-24-0" align="center" valign="top" style="padding: 20px 0px 25px 0px;">
                                            <img src="{{config('app.app_page')}}/images/logo_2.png" class="" width="167" height="37" alt="" style="display: block;border: 0;outline: 0;line-height: 100%;-ms-interpolation-mode: bicubic;width:167px;height: auto;max-width: 100%;" />
                                        </td>
                                    </tr>
                                </table>
