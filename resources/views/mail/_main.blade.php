            ...
            <div class="nk-content-body">
                <div class="content-page wide-md m-auto">
                                    ...
                                    <tr>
                                        <td class="py-5">
                                            ...
                                            <table class="email-body text-center">
                                                ...
                                                <tr>
                                                    <td class="p-3 p-sm-5">
                                                        <h5 class="email-heading email-heading-s1 mb-4">Hi Candy<br>Purchase and get lifetime update!</h5>
                                                        <p class="fs-16px text-base">Say hello to version 1.1. Introducing email template with massaging application concept and as always modern, clean and easier to use.</p>
                                                        <p>Hope you'll enjoy the experience, we're here if you have any questions, drop us a line at info@yourwebsite.com anytime. </p>
                                                    </td>
                                                </tr>
                                                </tbody>
                    ...
                    <div class="nk-block">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                <h4 class="title text-soft mb-4 overline-title">Notification - Welcome Email Template</h4>
                                <table class="email-wraper">
                                    <tr>
                                        <td class="py-5">
                                            <table class="email-header">
                    ...
                    <div class="nk-block">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                <h4 class="title text-soft mb-4 overline-title">Notification - Password Reset Template</h4>
                                <table class="email-wraper">
                                    <tr>
                                        <td class="py-5">
                                            <table class="email-header">
                                            ...
                                            <table class="email-body text-center">
                                                ...
                                                <tr>
                                                    <td class="px-3 px-sm-5 pb-2">
                                                        ...
                                                        <a href="#" class="email-btn">RESET PASSWORD</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="px-3 px-sm-5 pt-4 pb-3 pb-sm-5">
                    ...
                    <div class="nk-block">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                <h4 class="title text-soft mb-4 overline-title">Notification - Password Changed Template</h4>
                                <table class="email-wraper">
                                    <tr>
                                        <td class="py-5">
                                            <table class="email-header">
                    ...
                    <div class="nk-block">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                <h4 class="title text-soft mb-4 overline-title">Notification - KYC Submission Template</h4>
                                <table class="email-wraper">
                                    <tr>
                                        <td class="py-5">
                                            <table class="email-header">
                    ...
                    <div class="nk-block">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                <h4 class="title text-soft mb-4 overline-title">Notification - KYC Missing Template</h4>
                                <table class="email-wraper">
                                    <tr>
                                        <td class="py-5">
                                            <table class="email-header">
                                            ...
                                            <table class="email-body text-center">
                                                ...
                                                <tr>
                                                    <td class="px-3 px-sm-5 pt-3 pt-sm-5 pb-4">
                                                        <img class="w-100px" src="./images/email/kyc-pending.png" alt="Pending">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="px-3 px-sm-5 pb-3 pb-sm-5">
                                                        <h5 class="text-warning mb-3">We found some information missing in application.</h5>
                                                        <p>In our verification process, we found information are missing. It would great if you resubmit the form. If face problem in submission please contact us with our best ever excelent support team.</p>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <tr>
                                        <td class="py-5">
                                            ...
                                            <table class="email-body text-center">
                                                ...
                                                <tr>
                                                    <td class="px-3 px-sm-5 pt-3 pt-sm-5 pb-4">
                                                        <img class="w-100px" src="./images/email/kyc-success.png" alt="Verified">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="px-3 px-sm-5 pb-3 pb-sm-5">
                                                        <h5 class="text-success mb-3">Your Identity Verified.</h5>
                                    ...
                                    <tr>
                                        <td class="py-5">
                                            ...
                                            <table class="email-body">
                                                <tbody>
                                                <tr>
                                                    <td class="text-center px-3 px-sm-5 pt-3 pt-sm-5 pb-4"><img src="./images/slides/slide-a.jpg" alt="image"></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center px-3 px-sm-5 pb-5">
                                                        <h2 class="email-heading email-heading-sm">How to request a payment.</h2>
                                                        <p class="mgb-1-5x">Lorem Ipsum decided to leave for the far World of Grammar. The Big Oxmox advised her not to do so, because there were thousands of bad Comma</p><a href="#" class="email-btn email-btn-sm">Read More</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center px-3 px-sm-5 pb-4"><img src="./images/slides/slide-b.jpg" alt="image"></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center px-3 px-sm-5 pb-5">
                                                        <h2 class="email-heading email-heading-sm">How to request a payment.</h2>
                                                        <p>Lorem Ipsum decided to leave for the far World of Grammar.</p>
                                                        <p>Wild Question Marks and devious Semikoli, but the Little Blind Text didn’t listen. She packed her seven versalia, put her initial into the belt and made herself on the way</p>
                                                        <p>Lorem Ipsum decided to leave for the far World of Grammar. The Big Oxmox advised her not to do so, because there were thousands of bad Commans.</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center px-3 px-sm-5 pb-4"><img src="./images/slides/slide-c.jpg" alt="image"></td>
                                                </tr>
                                                <tr>
                                                    <td class="px-3 px-sm-5 pb-5">
                                                        <h2 class="email-heading email-heading-sm">Our New Update release.</h2>
                                                        <table class="w-100">
                                                            <tbody>
                                                            <tr>
                                                                <td class="w-100">
                                                                    <ul class="email-ul email-ul-col2">
                                                                        <li>Decenterlized</li>
                                                                        <li>Faster Access</li>
                                                        ...
                                                        </table><a href="#" class="email-btn email-btn-sm mt-2">Read More</a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
